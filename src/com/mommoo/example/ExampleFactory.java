...
//            frame.getContainer().setLayout(new LinearLayout(Orientation.VERTICAL));
    ...
    public static class FlatListViewExample {
        public static void example1() {
            ...
            FlatButton button = new FlatButton("INSERT",Color.PINK);
        ...
        public static void example3(){
            ...
            JButton button1 = new JButton("異�媛�");
            JButton button2 = new JButton("����");
            JButton button3 = new JButton("���� & 異�媛�");
            panel.add(button1);
            panel.add(button2);
            panel.add(button3);
            ...
            button1.addActionListener(e->{
                listView.addItem(new FlatLabel("������ ���댄��!! "));
            });
            ...
            button3.addActionListener(e->{
                listView.clear();
                for (int i = 0 ; i < 20 ; i ++){
                    listView.addItem(new FlatLabel("���댄��!!  " + i));
                }
            });
...
//            panel.setPreferredSize(new Dimension(1,50));
    ...
    public static class FlatTextFieldExample {
        public static void example1() {
            ...
            ((FlatTextField)frame.getContainer().getComponent(3)).setText("媛�����");
            frame.show();
        }
